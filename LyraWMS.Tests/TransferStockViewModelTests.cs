...
public class TransferStockViewModelTests
{
    ...
    public async Task TestTransferStockInvalidSubmission()
    {
        ...
        var transferStockViewModel = new TransferStockViewModel(productServiceMock.Object, notificationServiceMock.Object);

        transferStockViewModel.MoveStock();
        
        productServiceMock.VerifyNoOtherCalls();
        notificationServiceMock.Verify(n => n.DisplayAlert(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()));
    }
    ...
    public async Task TestTransferStockNoQuantitySubmission()
    {
        ...
        transferStockViewModel.OldProductLocation = transferStockViewModel.Product.ProductLocations[0];
        transferStockViewModel.MoveStock();
        
        productServiceMock.VerifyNoOtherCalls();
        notificationServiceMock.Verify(n => n.DisplayAlert(
            It.IsAny<string>(), 
    ...
    public async Task TestTransferStockValidSubmission()
    {
        ...
        productServiceMock.Setup(p =>
                p.MoveStock(It.IsAny<Product>(), It.IsAny<int>(), It.IsAny<Location>(), It.IsAny<ProductLocation>()))
            .ReturnsAsync(true);
        ...
        transferStockViewModel.NewLocation = new Location()
        {
            Id = 1,
            Name = "foo"
        };
        transferStockViewModel.SelectedWarehouse = new Warehouse()
        {
            Name = "The Destined"
        };
        transferStockViewModel.OldProductLocation = transferStockViewModel.Product.ProductLocations[0];
        ...
        productServiceMock.Verify(p => p.MoveStock(
